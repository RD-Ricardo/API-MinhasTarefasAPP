...
namespace MyTaskApp_Api.Migrations
{
    ...
    [Migration("20211213200818_Token")]
    partial class Token
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTaskApp_Api.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("MyTaskApp_Api.Models.Tarefa", b =>
                {
            ...
            modelBuilder.Entity("MyTaskApp_Api.Models.Token", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyTaskApp_Api.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyTaskApp_Api.Models.Tarefa", b =>
                {
                    b.HasOne("MyTaskApp_Api.Models.ApplicationUser", "Usuario")
                        .WithMany("Tarefas")
